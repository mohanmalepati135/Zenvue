<div align="center">
  ...
  <h3 align="center">Zenvue: A job interview preparation platform powered by Vapi AI Voice agents</h3>
...
```bash
git clone https://github.com/mohanmalepati135/Zenvue.git
cd Zenvue
```
...
Public assets used in the project can be found [here](https://drive.google.com/drive/folders/1EucYi4SSvRTnoKn0Pj90DAyYBsQb9VQk?usp=drive_link)
